import { calculerPourcentageNiveauxbombes } from "/coc/code/village principal/batiments/calculator/piege calc/bombes/bombe global.calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de bombe
    const bombeSelects = document.querySelectorAll('select[id^="bombe"]');
