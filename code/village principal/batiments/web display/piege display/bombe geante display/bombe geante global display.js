import { calculerPourcentageNiveauxbombe_geantes } from "/coc/code/village principal/batiments/calculator/piege calc/bombe geantes/bombe geante global.calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de bombe_geante
    const bombe_geanteSelects = document.querySelectorAll('select[id^="bombe_geante"]');
