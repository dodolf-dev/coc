import { calculerPourcentageNiveauxpiege_squelettiques } from "/coc/code/village principal/batiments/calculator/piege calc/piege squelettiques/piege squelettique global.calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de piege_squelettique
    const piege_squelettiqueSelects = document.querySelectorAll('select[id^="piege_squelettique"]');
