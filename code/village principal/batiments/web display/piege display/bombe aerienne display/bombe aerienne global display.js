import { calculerPourcentageNiveauxbombe_aeriennes } from "/coc/code/village principal/batiments/calculator/piege calc/bombe aeriennes/bombe aerienne global.calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de bombe_aerienne
    const bombe_aerienneSelects = document.querySelectorAll('select[id^="bombe_aerienne"]');
