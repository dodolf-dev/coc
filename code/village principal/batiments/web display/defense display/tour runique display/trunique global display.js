import { calculerPourcentageNiveauxtour_runiques } from "/coc/code/village principal/batiments/calculator/defense calc/tour runiques/tour runique global calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const tour_runiqueelects = document.querySelectorAll('select[id^="tour_runique"]');
  
    tour_runiqueelects.forEach(select => {
