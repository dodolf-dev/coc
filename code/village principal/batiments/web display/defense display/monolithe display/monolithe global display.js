import { calculerPourcentageNiveauxmonolithe } from "/coc/code/village principal/batiments/calculator/defense calc/monolithe/monolithe global calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de monolithe
    const monolitheelects = document.querySelectorAll('select[id^="monolithe"]');
