import { calculerPourcentageNiveauxsouffleur_airs } from "/coc/code/village principal/batiments/calculator/defense calc/souffleur airs/souffleur air global calc.js";
...
function updateProgressPercentage() {
    ...
    const progressBar = document.getElementById('progress-souffleur_air');
    const progressText = document.getElementById('progress-souffleur_air-value');
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de souffleur_air
    const souffleur_airSelects = document.querySelectorAll('select[id^="souffleur_air"]');
