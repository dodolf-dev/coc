import { calculerPourcentageNiveauxtour_enfers } from "/coc/code/village principal/batiments/calculator/defense calc/tour enfers/tour enfer global calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const tour_enferelects = document.querySelectorAll('select[id^="tour_enfer"]');
  
    tour_enferelects.forEach(select => {
