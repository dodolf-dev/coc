import { calculerPourcentageNiveauxtour_archeres } from "/coc/code/village principal/batiments/calculator/defense calc/tour archeres/tour archere global calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const tour_archereelects = document.querySelectorAll('select[id^="tour_archere"]');
  
    tour_archereelects.forEach(select => {
