import { calculerPourcentageNiveauxCanons } from "/coc/code/village principal/batiments/calculator/defense calc/canons/canon_global_calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const canonSelects = document.querySelectorAll('select[id^="canon"]');
