import { calculerPourcentageNiveauxmortiers } from "/coc/code/village principal/batiments/calculator/defense calc/mortiers/mortier global calc.js";

// Fonction pour mettre à jour le pourcentage de progression
function updateProgressPercentage() {
    const progression = calculerPourcentageNiveauxmortiers();
    const progressBar = document.getElementById('progress-mortier');
    const progressText = document.getElementById('progress-mortier-value');
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de mortier
    const mortierSelects = document.querySelectorAll('select[id^="mortier"]');
