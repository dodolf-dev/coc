import { calculerPourcentageNiveauxteslas } from "/coc/code/village principal/batiments/calculator/defense calc/teslas/tesla global calc.js";

// Fonction pour mettre à jour le pourcentage de progression
function updateProgressPercentage() {
    const progression = calculerPourcentageNiveauxteslas();
    const progressBar = document.getElementById('progress-tesla');
    const progressText = document.getElementById('progress-tesla-value');
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de tesla
    const teslaSelects = document.querySelectorAll('select[id^="tesla"]');
