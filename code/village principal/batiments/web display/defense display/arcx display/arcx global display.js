import { calculerPourcentageNiveauxarcxs } from "/coc/code/village principal/batiments/calculator/defense calc/arcxs/arcx global calc.js";

// Fonction pour mettre à jour le pourcentage de progression
function updateProgressPercentage() {
    const progression = calculerPourcentageNiveauxarcxs();
    const progressBar = document.getElementById('progress-arcx');
    const progressText = document.getElementById('progress-arcx-value');
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de arcx
    const arcxSelects = document.querySelectorAll('select[id^="arcx"]');
