import { calculerPourcentageNiveauxtour_sorciers } from "/coc/code/village principal/batiments/calculator/defense calc/tour sorciers/tour sorcier global calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const tour_sorcierelects = document.querySelectorAll('select[id^="tour_sorcier"]');
  
    tour_sorcierelects.forEach(select => {
