import { calculerPourcentageNiveauxaigle_artilleur } from "/coc/code/village principal/batiments/calculator/defense calc/aigle artilleur/aigle artilleur global calc.js";
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de aigle_artilleur
    const aigle_artilleurelects = document.querySelectorAll('select[id^="aigle_artilleur"]');
