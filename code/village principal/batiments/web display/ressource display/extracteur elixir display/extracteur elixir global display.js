import { calculerPourcentageNiveauxextracteur_elixirs } from "/coc/code/village principal/batiments/calculator/ressource calc/extracteur elixirs/extracteur elixir global calc.js";
...
function updateProgressPercentage() {
    ...
    const progressBar = document.getElementById('progress-extracteur_elixir');
    const progressText = document.getElementById('progress-extracteur_elixir-value');
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de extracteur_elixir
    const extracteur_elixirSelects = document.querySelectorAll('select[id^="extracteur_elixir"]');
