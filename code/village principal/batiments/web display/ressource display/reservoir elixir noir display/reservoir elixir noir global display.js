import { calculerPourcentageNiveauxreservoir_elixir_noirs } from "/coc/code/village principal/batiments/calculator/ressource calc/reservoir elixirs/reservoir elixir noir global calc.js";

// Fonction pour mettre à jour le pourcentage de progression
function updateProgressPercentage() {
    const progression = calculerPourcentageNiveauxreservoir_elixir_noirs();
    const progressBar = document.getElementById('progress-reservoir_elixir_noirs');
    const progressText = document.getElementById('progress-reservoir_elixir_noirs-value');
