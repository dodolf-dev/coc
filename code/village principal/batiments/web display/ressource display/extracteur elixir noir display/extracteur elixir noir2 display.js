...
function updateextracteur_elixir_noir2Info() {
    ...
    document.getElementById("extracteur_elixir_noir2_prix_niveau").innerHTML = `Prix restant : ${formatPrix(prixrestant)} <img src="/coc/image/village principal/ressource/or village-p.jpg" alt="or" class="icone-ressource">`;
