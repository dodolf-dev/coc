import { calculerPourcentageNiveauxmine_ors } from "/coc/code/village principal/batiments/calculator/ressource calc/mine ors/mine or global calc.js";

// Fonction pour mettre à jour le pourcentage de progression
function updateProgressPercentage() {
    const progression = calculerPourcentageNiveauxmine_ors();
    const progressBar = document.getElementById('progress-mine_or');
    const progressText = document.getElementById('progress-mine_or-value');
...
window.addEventListener('DOMContentLoaded', () => {
    // Applique le surlignage à tous les selects de mine_or
    const mine_orSelects = document.querySelectorAll('select[id^="mine_or"]');
